...
### [ChatGPT Next Web](https://github.com/Yidadaa/ChatGPT-Next-Web) ⭐ 88,740 | 🐛 862 | 🌐 TypeScript | 📅 2026-08-11
...
## [基于tauri方案](https://github.com/tauri-apps/tauri) ⭐ 110,985 | 🐛 1,462 | 🌐 Rust | 📅 2026-09-10

> 关于 使用 Web 前端构建更小、更快和更安全的桌面应用程序

### [ChatGPT](https://github.com/lencx/ChatGPT) ⭐ 54,510 | 🐛 945 | 🌐 Rust | 📅 2024-08-29

  <img src="https://github.com/lencx/ChatGPT/raw/main/assets/chatgpt-cmd.png">

* 支持斜杠命令及其配置（可手动配置或从文件同步 [#55](https://github.com/lencx/ChatGPT/issues/55) ⭐ 54,510 | 🐛 945 | 🌐 Rust | 📅 2024-08-29）
* 自定义全局快捷键 ([#108](https://github.com/lencx/ChatGPT/issues/108) ⭐ 54,510 | 🐛 945 | 🌐 Rust | 📅 2024-08-29)
* 划词搜索 ([#122](https://github.com/lencx/ChatGPT/issues/122) ⭐ 54,510 | 🐛 945 | 🌐 Rust | 📅 2024-08-29 鼠标选中文本，不超过 400 个字符)：应用使用 Tauri 构建，因其安全限制，会导致部分操作按钮无效，建议前往浏览器操作。
...
### [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) ⭐ 46,891 | 🐛 22 | 🌐 Python | 📅 2026-09-11
...
## [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,926 | 🐛 77 | 🌐 HTML | 📅 2026-09-09
...
## [ChatGPT 中文调教指南](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ⭐ 62,208 | 🐛 45 | 📅 2026-04-28
...
### [one-api](https://github.com/songquanpeng/one-api?tab=readme-ov-file) ⭐ 36,846 | 🐛 1,034 | 🌐 JavaScript | 📅 2026-01-09
