# Awesome chat-gpt-full-stack with stars
...
### [ChatGPT\_JCM](https://github.com/202252197/ChatGPT_JCM) ⭐ 2,922 | 🐛 37 | 🌐 Vue | 📅 2025-01-18
...
### [ChatGPT Web](https://github.com/Chanzhaoyu/chatgpt-web) ⚠️ Archived
...
### [ChatGPT Next Web](https://github.com/Yidadaa/ChatGPT-Next-Web) ⭐ 88,720 | 🐛 859 | 🌐 TypeScript | 📅 2026-08-11
...
### [chatgpt-demo](https://github.com/ddiu8081/chatgpt-demo) ⭐ 7,934 | 🐛 48 | 🌐 TypeScript | 📅 2023-12-27

一个基于 OpenAI GPT-3.5 Turbo API 的 demo。 <img src="https://camo.githubusercontent.com/87fde0adf3cbf79cb77a0cfbf586618e6772aabb02775f1d1feef4177227ab91/68747470733a2f2f63646e2e737461746963616c792e636f6d2f67682f797a683939303931382f737461746963406d61737465722f636861742d6c6f676f2e77656270"/>

### [ChatGPT-Vercel](https://github.com/ourongxing/chatgpt-vercel) ⚠️ Archived
...
### [QA power by gpt](https://github.com/gcloudlab/QA) ⭐ 136 | 🐛 0 | 🌐 TypeScript | 📅 2023-04-30

部署在Vercel的ChatGPT镜像站点（gpt-3.5-turbo）
支持随机生成预设场景（100+）
支持缓存会话 <img src="https://raw.githubusercontent.com/gcloudlab/QA/main/web.png"/>
...
### [chatgpt-ui](https://github.com/WongSaang/chatgpt-ui) ⭐ 1,624 | 🐛 100 | 🌐 Vue | 📅 2026-05-11
...
PHP版调用OpenAI的API接口进行问答的Demo，代码已更新为调用最新的gpt-3.5-turbo模型。 采用Stream流模式通信，一边生成一边输出 <img src="https://user-images.githubusercontent.com/5563148/224522389-f60e3047-c0e6-49cd-bee7-80feaf2c86a4.png"/>

# desktop 桌面端

## [基于tauri方案](https://github.com/tauri-apps/tauri) ⭐ 110,904 | 🐛 1,466 | 🌐 Rust | 📅 2026-09-08

> 关于 使用 Web 前端构建更小、更快和更安全的桌面应用程序

### [ChatGPT](https://github.com/lencx/ChatGPT) ⭐ 54,494 | 🐛 944 | 🌐 Rust | 📅 2024-08-29

  <img src="https://github.com/lencx/ChatGPT/raw/main/assets/chatgpt-cmd.png">

* 支持斜杠命令及其配置（可手动配置或从文件同步 [#55](https://github.com/lencx/ChatGPT/issues/55) ⭐ 54,494 | 🐛 944 | 🌐 Rust | 📅 2024-08-29）
* 自定义全局快捷键 ([#108](https://github.com/lencx/ChatGPT/issues/108) ⭐ 54,494 | 🐛 944 | 🌐 Rust | 📅 2024-08-29)
* 划词搜索 ([#122](https://github.com/lencx/ChatGPT/issues/122) ⭐ 54,494 | 🐛 944 | 🌐 Rust | 📅 2024-08-29 鼠标选中文本，不超过 400 个字符)：应用使用 Tauri 构建，因其安全限制，会导致部分操作按钮无效，建议前往浏览器操作。
...
### [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) ⭐ 46,823 | 🐛 24 | 🌐 Python | 📅 2026-09-08
...
### [wechat-chatgpt](https://github.com/fuergaosi233/wechat-chatgpt) ⭐ 13,235 | 🐛 53 | 🌐 TypeScript | 📅 2024-05-20

## 基于php

[chatgpt-wechat-personal](https://github.com/dirk1983/chatgpt-wechat-personal) ⭐ 131 | 🐛 2 | 🌐 PHP | 📅 2025-07-24
实现原理：
腾讯服务器推送用户消息过来时，调用OpenAI的API接口，并将用户的问题和返回的结果存到日志文件中。
在5秒内很可能收不到OpenAI返回的消息。没关系，直接让腾讯服务器发过来的请求响应超时。
等腾讯第二次或第三次查询的时候，第一次请求调用OpenAI的结果也返回并写到文件中了，直接从文件中获取结果返回给用户。 <img src="https://user-images.githubusercontent.com/5563148/223959556-b9970db1-66fb-46fa-b3af-54d51c74cd5b.jpg"/>

# prompts 相关

## [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,620 | 🐛 75 | 🌐 HTML | 📅 2026-09-06
...
## [ChatGPT 中文调教指南](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ⭐ 62,123 | 🐛 45 | 📅 2026-04-28
...
### [chatgptProxyAPI](https://github.com/x-dr/chatgptProxyAPI) ⚠️ Archived

> 使用cloudflare 搭建免费的 OpenAI api代理 ，解决网络无法访问问题。支持 Stream 流式输出

## 浏览器插件

### [chathub](https://github.com/chathub-dev/chathub) ⭐ 10,654 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-27
...
### [one-api](https://github.com/songquanpeng/one-api?tab=readme-ov-file) ⭐ 36,781 | 🐛 1,033 | 🌐 JavaScript | 📅 2026-01-09
